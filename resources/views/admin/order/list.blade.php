...
{{--                                <a href="{{route('promo.add')}}" class="btn btn-primary">--}}
{{--                                    Thêm mới--}}
{{--                                </a>--}}
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <div class="userDatatable-inline-title">
                                                        <a href="#" class="text-dark fw-500">
                                                            <h6>{{number_format($value->into_money, 0, ',', '.')}} VNĐ</h6>
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <ul class="orderDatatable_actions mb-0 d-flex flex-wrap">
                                                                                                    <li>
                                                                                                        <a href="{{route('order.detail', [$value->id])}}" class="view">Chi tiết
                                                                                                            <i class="uil uil-setting"></i>
                                                                                                        </a>
                                                                                                    </li>
                                                    <li>
                                                        <a class="btn btn-secondary mx-1" href="{{route('order.edit', [$value->id])}}" >Sửa</a>
                                                    </li>
{{--                                                    <li>--}}
{{--                                                        <a class="btn btn-secondary mx-1" href="" >Chi tiết</a>--}}
{{--                                                    </li>--}}
                                                    <li>
        ...
        function deletItem(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `{{url('wp-admin/orders/delete')}}`+`/`+ id;
                }
            })
        }
    </script>
