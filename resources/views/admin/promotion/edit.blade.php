                    ...
                    <div
                        ...
                        <div class="row justify-content-center">
                            <div class="col-xxl-7 col-lg-10">
                                <form action="{{route('promo.edit', [$value[0]->id])}}" method="post">
                                    @csrf
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div class="add-product__body px-sm-40 px-20">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="name1">promotion name</label>
                                                        <input type="text" class="form-control" name="name"
                                                               placeholder="Nhập dữ liệu" value="{{$value[0]->name}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name1">promotion code</label>
                                                        <input type="text" class="form-control" name="code"
                                                               placeholder="Nhập dữ liệu" value="{{$value[0]->code}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name1">promotion price</label>
                                                        <input type="text" class="form-control" name="price"
                                                               placeholder="Nhập dữ liệu" value="{{$value[0]->price}}">
                                                    </div>
