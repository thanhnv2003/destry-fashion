                ...
                <div class="col-lg-12 col-md-8 m-auto m-lg-0 pb-10">
                    ...
                    <div class="login-wrapper">
                        ...
                        <div class="section-content text-center mb-5">
                            ...
                            <p class="desc-content">Please forgot using account detail bellow.</p>
                        </div>
                        ...
                        <form action="{{route('forgot')}}" method="post">
                            ...
                            <!-- Login Button Start -->
                            <div class="single-input-item mb-3">
                                <input name="btnForgot" type="submit" class="btn btn btn-dark btn-hover-primary rounded-0" value="Yêu cầu">
                            </div>
                            <!-- Login Button End -->
